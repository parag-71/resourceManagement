...
Ext.define('Gnt.model.mixin.ProjectableModel', function() {
    ...
    function isProjected(fieldName, currentProjectionOnly) {
        ...
        if (projection) {
            ...
            if (fieldName) {
                hasProjectedField = currentProjectionOnly ? projection.hasOwnProperty(fieldName) : fieldName in projection;
    ...
    var flexSetProjectionResult = Ext.Function.flexSetter(function(fieldName, value) {
        ...
        if (
            ...
            if (record.processFieldPreviousValue) {
                currentValue = record.processFieldPreviousValue(fieldName, currentValue);
            }
